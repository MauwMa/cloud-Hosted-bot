module.exports = {
    ...
    execute (client, message, args, Discord){
        ...
        .setURL('')
        .setDescription('Már úgy is tudod, nem igaz? Mivel olyan sok időt töltöttem azzal, hogy ilyen ruhába öltözzek a kedvedért... Heh, viszonozásképp rengeteg idődet fogom elrabolni. Hehehe.\n\nKMS Peter Strasser új ruhájába öltözik. A közeljövőben a dokkodban fog várni, Parancsnok.')
