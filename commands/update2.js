module.exports = {
    ...
    execute (client, message, args, Discord){
        ...
        .setTitle('❀Befészkelődni a hosszú éjszakákra❀')
        .setURL('')
        .setTimestamp()
        .setDescription(`Segíteni szerettem volna a stresszed eloszlatásában, ezért úgy gondoltam hogy népmeséket olvasok neked...Amikor ezt megemlítettem, Akashi ezeket a ruhákat ajánlotta nekem... M-Mit gondolsz?\n\nIJN Naganami új ruhájába öltözik. A közeljövőben a dokkodban fog várni, Parancsnok.`)        
