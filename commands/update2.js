...
module.exports = {
    ...
    execute (client, message, args, Discord){
            ...
            .setTitle('❀Hakuryuu❀')
            .setURL('')
            .setDescription('Szóval ez a sik kölök lenne a parancsnok? Hakuryuu a nevem. Figyelj jól - próbálj meg irányítani, és nevetségtárgyává fogod tenni magad. Emlékezz erre! IJN Hakuryuu felkészül a bevetésre és hamarosan a dokkodat fogja díszíteni a közel jövőben, Parancsnok.')
