module.exports = {
    ...
    execute (client, message, args, Discord){
        ...
        .setURL('')
        .setTimestamp()
        .setDescription('Agir, Akashi, Alabama, Aquila, Arkroyal, Atago, Ayanami, Azuma, Bismarck, Bremerton, DukeofYork(doy), Formidable, Friedrich(fdg), Heinrich, Helena, HelenaMETA, Hipper, Hood, Howe, Ibuki, Independence, Intrepid, Jeanbart JeannedArc, Kashino, Kasumi, Kent, Kinggeorge, Kinu, Laffey, LeMalin, London, LongIsland, Mainz, Maya, Montpelier, Mutsuki, Nagato, Nakiriayame, Neptune, NorthCarolina, NewJersey, Noshiro, Nurnberg, Odin, Ookamimio, Perseus, PrinzEugen, Ranger, Richelieu, Roon, Ryuuhou, Saintlousis, SanDiego, SanFrancisco, Scharnhorst, Seattle, Shangrila,  Shimakaze, Shinano, ShirakamiFubuki, Shoukaku, Souryuu, SouthDakota, Sovetskaya, Suruga, Suzutsuki, Swiftsure, Tashkent, Tirpitz, Tosa, Warspite, Yukikaze, Z23')
