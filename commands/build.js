module.exports = {
    ...
    execute (client, message, args, Discord){
        ...
        .setURL('')
        .setDescription('Akashi, Alabama, Aquila, Arkroyal, Atago, Ayanami, Azuma, Bismarck, Bremerton, Formidable, Friedrich, Heinrich, Helena, Hipper, Hood, Howe, Ibuki, Independence, Intrepid, JeannedArc, Kashino, Kasumi, Kent, Kinggeorge, Kinu, Laffey, London, LongIsland, Mainz, Maya, Montpelier, Mutsuki, Nagato, Nakiriayame, Neptune, NewJersey, Noshiro, Nurnberg, Odin, Ookamimio, Perseus, PrinzEugen, Ranger, Richelieu, Roon, Ryuuhou, Saintlousis, SanDiego, SanFrancisco, Scharnhorst, Seattle, Shangrila, Shinano, ShirakamiFubuki, Souryuu, SouthDakota, Sovetskaya, Suruga, Suzutsuki, Swiftsure, Tashkent, Tirpitz, Tosa, Warspite, Yukikaze, Z23')
